  ...
  <body class="page-<?php echo Request::get('id'); ?>">
    ...
    <nav class="navbar navbar-default navbar-inverse" role="navigation">
      <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo Site::url() . '/' . ADMIN ?>/index.php?id=dashboard">MONSTRA.R</a>
          </div>
    ...
    <div class="container">
      ...
      <footer class="container visible-md visible-lg">
          <p class="pull-right">
            <span>
              <a href="http://monstra.org" target="_blank">Monstra</a> was made by <a href="http://awilum.github.io" target="_blank" class="highlight">Sergey Romanenko</a> and is maintained by <a href="https://github.com/monstra-cms/monstra/network/members" target="_blank" class="highlight">Monstra Community</a> / © 2012 - 2017 <a href="https://github.com/ravilrrr/Monstra.R-CMS" target="_blank">Monstra.R</a> – <?php echo __('Version', 'system'); ?> <?php echo Monstra::VERSION; ?>
            </span>
          </p>
      </footer>
</body>
