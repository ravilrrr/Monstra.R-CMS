<div class="vertical-align margin-bottom-1">
    ...
    <div class="text-right row-phone">
        <a href="index.php?id=pages&amp;action=add_page" title="<?php echo __('Create New Page', 'pages'); ?>" class="btn btn-phone btn-primary"><?php echo __('Create New Page', 'pages'); ?></a>
        <a href="index.php?id=pages&action=edit_page&name=error404" title="<?php echo __('Edit 404 Page', 'pages'); ?>" class="btn btn-phone btn-default"><?php echo __('Edit 404 Page', 'pages'); ?></a>
    </div>
</div>
...
<table class="table table-bordered">
    ...
    <?php if (count($pages) != 0) { ?>
        <?php foreach ($pages as $page) { ?>
            <?php if ($page['parent'] != '') { $dash = Html::arrow('right').'&nbsp;&nbsp;'; } else { $dash = ""; } ?>
                    ...
                    <div class="pull-right">
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="divider"></li>
                                <li><a href="index.php?id=pages&action=delete_page&name=<?php echo $page['slug']; ?>&token=<?php echo Security::token(); ?>" onclick="return confirmDelete('<?php echo __('Delete page: :page', 'pages', array(':page' => Html::toText($page['title']))); ?>')"><?php echo __('Delete', 'pages'); ?></a></li>
                          </ul>
                        </div>
                    </div>
                </td>
